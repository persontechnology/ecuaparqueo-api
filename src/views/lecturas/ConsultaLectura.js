...
import { Input,Icon,FormControl,Stack,Heading ,Button,useToast, Text,Center} from 'native-base';
...
export default function ConsultaLectura() {
    ...
    const  acceder= async()=>{
        setcargando(true);
        try {
            const res=await fetch(API_URL+"lectura-entrada-vehicular",{
                method:'POST',
                headers:{
  ...
  return (
            ...
            <Card>
                <Card.Title>Consulta de Lectura entrada vehícular</Card.Title>
                <Card.Divider />
                ...
                <Stack>
                    ...
                    />
                    <Button mt="2" isLoading={cargando}  isLoadingText="Procesando..." colorScheme={"success"} onPress={acceder}>
